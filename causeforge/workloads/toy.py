...
from causeforge.runtime.agent import ScriptedStep
...
def build_tasks() -> list[ToyTask]:
    ...
    tasks.append(ToyTask(
        ...
        fixes=[Intervention(
            ...
            target_step=0,
            new_action=ToolCall(tool="write_file", args={"path": "solution.py", "content": FIB_OK}),
    ...
    tasks.append(ToyTask(
        ...
        fixes=[Intervention(
            type=InterventionType.ACTION_REPLACE,
            target_step=0,
            new_action=ToolCall(tool="write_file", args={"path": "solution.py", "content": MEAN_OK}),
