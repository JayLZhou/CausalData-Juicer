...
def build_tasks() -> list[DepMigTask]:
    ...
    tasks.append(
        DepMigTask(
            ...
            migration_points=[
                "click.get_os_args removed (-> sys.argv[1:])",
    ...
    tasks.append(
        DepMigTask(
            ...
            migration_points=[
                ...
                "click.get_terminal_size removed (second module)",
            ],
            files={
                "targets.py": (
