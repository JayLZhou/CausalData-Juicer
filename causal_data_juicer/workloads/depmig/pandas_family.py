...
def build_tasks() -> list[DepMigTask]:
    ...
    tasks.append(
        DepMigTask(
            ...
            migration_points=[
                "mean()/median() on mixed frames raise in 2.x (numeric_only, two sites)"
            ],
            files={
                "summary.py": (
                    "import pandas as pd\n"
    ...
    tasks.append(
        DepMigTask(
            ...
            migration_points=[
                ...
                "Series.iteritems removed (second module)",
            ],
            files={
                "collect.py": (
                    "import pandas as pd\n"
    ...
    tasks.append(
        DepMigTask(
            ...
            migration_points=[
                "read_csv(squeeze=) removed (-> .squeeze('columns'))",
    ...
    tasks.append(
        DepMigTask(
            ...
            migration_points=[
                "DataFrame.iteritems removed",
                "Series.append removed (second module)",
            ],
            files={
                "shape.py": (
                    "import pandas as pd\n"
